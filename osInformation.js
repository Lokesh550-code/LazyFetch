...
const cpucoreSpeed = os.cpus()[0].speed;
...
module.exports = {host, userName, osVersion, osPlatform, uptime, cpuName, freeMemoryGb, totalMemoryGb, nodeVersion, kernel, cpuCores, cpucoreSpeed}